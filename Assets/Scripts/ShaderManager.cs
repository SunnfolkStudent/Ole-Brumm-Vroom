...
public class ShaderManager : MonoBehaviour
{
    ...
    private float _currentIncrementHoney;
    private float _currentIncrementColor;
    ...
    private void Update()
    {
        _currentHoneyAmount += _currentIncrementHoney;
        _currentColorStrength += _currentIncrementColor;
    ...
    private void PhaseUpdateShaderVariables(int phase)
    {
        ...
        {
            case 1:
                _currentIncrementHoney = 0.00010f;
                _currentIncrementColor = 0.00010f;
            ...
            case 2:
                ...
                break;
            case 3:
                _currentIncrementHoney = 0.00040f;
                _currentIncrementColor = 0.00040f;
                ...
                break;
            case 4:
                _currentIncrementHoney = 0.00080f;
                _currentIncrementColor = 0.00080f;
